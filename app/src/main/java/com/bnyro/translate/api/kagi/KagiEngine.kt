...
class KagiEngine : TranslationEngine(
    ...
    val skipDefinitionsKey = name + "SkipDefinitions"
    val useBestModelKey = name + "UseBestModel"
    ...
    override suspend fun translate(query: String, source: String, target: String): Translation {
        val skipDefinitions = Preferences.get(skipDefinitionsKey, false)
        val useBestModel = Preferences.get(useBestModelKey, false)
        
        val request = KagiTranslationRequest(
            text = query,
            sourceLang = sourceOrAuto(source),
            targetLang = target,
            skipDefinition = skipDefinitions,
